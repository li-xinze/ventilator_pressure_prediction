...
from project.utils import mkdir_p
from project.utils import read_yaml
from project.utils import save_yaml
...
def load_config(config_path: str) -> Dict:
    ...
    save_config(args, args['general_config']['result_path'])
...
def update_result_path(params: Dict, postfix: str = None) -> Dict:
    ...
    if 'train' not in params['general_config']['pipeline'][0]:
        ...
        if postfix is None:
            postfix = params['model_config']['model_name']
